...
public class Varieties implements IModel { 
	...
	* 获取 品种编号
	*/ 
	public String getVarietiesId(){ return varietiesId ; } 
	/** 
	* 设置 品种编号
	*/ 
	public void setVarietiesId(String varietiesId){ this.varietiesId=varietiesId ; } 
 	/** 
	* 获取 品种名称
	*/ 
	...
	* 设置 品种名称
	*/ 
	public void setVarietiesName(String varietiesName){ this.varietiesName=varietiesName ; } 
 	/** 
	* 获取 分类编号
	*/ 
