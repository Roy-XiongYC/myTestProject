...
private SequenceService sequenceService;
  ...
  public JsonResult<PageInfo<UserPet>> queryPage(@ApiParam(name = "pageNum", value = "页码") @RequestParam(name = "pageNum", required = false, defaultValue = "1") Integer pageNum,
			@ApiParam(name = "pageSize", value = "页面大小") @RequestParam(name = "pageSize", required = false, defaultValue = "10") Integer pageSize,
			@ApiParam(name = "id", value = "主键ID") @RequestParam(required = false) String id){      Criteria<UserPet> param = new Criteria<UserPet>(pageNum,pageSize);
  ...
  public JsonResult<Object> updateBatchByCriteria(@RequestBody List<UserPet> list){ 
     return userPetService.updateBatchByCriteria(list) == null ? AppResponseCode.success() : AppResponseCode.failure(); 
  }
  ...
  public JsonResult<UserPet> queryEntityById(@ApiParam(name = "id", value = "主键ID") @RequestParam(required = false) String id) { 
