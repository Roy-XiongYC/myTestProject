...
private SequenceService sequenceService;
  ...
  public JsonResult<PageInfo<ServiceProject>> queryPage(@ApiParam(name = "pageNum", value = "页码") @RequestParam(name = "pageNum", required = false, defaultValue = "1") Integer pageNum,
			@ApiParam(name = "pageSize", value = "页面大小") @RequestParam(name = "pageSize", required = false, defaultValue = "10") Integer pageSize,
			@ApiParam(name = "id", value = "主键ID") @RequestParam(required = false) String id){      Criteria<ServiceProject> param = new Criteria<ServiceProject>(pageNum,pageSize);
  ...
  public JsonResult<Object> updateBatchByCriteria(@RequestBody List<ServiceProject> list){ 
     return serviceProjectService.updateBatchByCriteria(list) == null ? AppResponseCode.success() : AppResponseCode.failure(); 
  }
  ...
  public JsonResult<Object> insertOrUpdateBatch(@RequestBody List<ServiceProject> list){ 
     return serviceProjectService.insertOrUpdateBatch(list) == null ? AppResponseCode.success() : AppResponseCode.failure(); 
  }
  ...
  public JsonResult<ServiceProject> queryEntityById(@ApiParam(name = "id", value = "主键ID") @RequestParam(required = false) String id) { 
  ...
  public JsonResult<Object> deleteEntityByCriteria(@ApiParam(name = "id", value = "主键ID") @RequestParam(required = false) String id) {
     ...
     return serviceProjectService.deleteByCriteria(param) == null ? AppResponseCode.success() : AppResponseCode.failure();
  }
  ...
  public JsonResult<Object> deleteBatchByIds(@ApiParam(name = "ids", value = "主键ID") @RequestParam String[] ids) {
    return serviceProjectService.deleteBatchByIds(ids) == null ? AppResponseCode.success() : AppResponseCode.failure();
  }
