...
//
//@Override
//  public Integer queryPageCount(Page<SysTest> page,Criteria<SysTest> param){
//    return (Integer) sysTestDao.queryPageCount(page,param);
//  }
	...
	@Override
	public PageInfo<SysTest> queryAll(Criteria<SysTest> param) {
		PageHelper.startPage(param.getPageNum(), param.getPageSize());
		return  new PageInfo<SysTest>(sysTestDao.queryAll(param));
	}
